        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item text-left"><strong>Duration:</strong>
                        {{ ceil($project['duration'] / (60 * 60 * 24)) }} days</li>
                ...
                <h3 class="mt-5">Tasks</h4>
                    ...
                    <div class="mb-3 text-left">
                        <a href="{{ route('tasks.create') . '?projects_id=' . $project['id'] }}" class="btn btn-primary">Add
                            new</a>
                    </div>
                        ...
                        @foreach ($tasks as $t)
                            <li class="list-group-item text-left">
                                ...
                                <span class="float-right">
                                    ...
                                    <div class="v-divider"></div>
                                    <a
                                        href="javascript:if (confirm('Delete task. Are you sure?')) location.href='{{ route('tasks.delete', ['id' => $t['id']]) . '?project_id=' . $project['id'] }}'">Delete</a>
                                </span>
