        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item text-left"><strong>Duration:</strong> {{ ceil($task['duration'] / (60 * 60 * 24)) }}
                        days</li>
                    <li class="list-group-item text-left"><strong>Project:</strong> {{ $task['project'] }}</li>
                </ul>

                <div class="mt-4"><a href="{{ route('projects.view', ['id' => $task['projects_id']]) }}">Back to project
                        details</a></div>
